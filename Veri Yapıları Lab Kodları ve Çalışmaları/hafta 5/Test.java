...
public class Test {
    ...
    public static<T extends Comparable> boolean search(CircularQueue<T> queue, 
                        T val ) throws Exception{
        Class<T> classType = (Class<T>) queue.values.getClass().getComponentType();
        CircularQueue<T> tempQ = new CircularQueue(classType, queue.size());
    ...
    public static void main(String[] args) throws Exception {
        ...
        list.addToEnd(5);
        list.display();
        Node<Integer> minNode=list.findMinNode();
...
//        myQueue.enQueue(13);
//        myQueue.display();
//        System.out.println(search(myQueue, 3));
//        
